...
## December 2025
I gave a talk at BNMIT regarding satellite embeddings and showed how it is useful and acts as a abtraction layer to L2 products. Check it out [here](https://www.canva.com/design/DAG6pC9Y6qk/jLImxL7Zk0hOMGOCEzamkA/edit).

I had my new year vacation (long pending) in Phuket! Amazing place and vibe. Back to grind!

## November 2025

Gave a talk on machine learning for geospatial analysis to show instance segmentation. workshop material is published [here](https://github.com/amanbagrecha/intro-geospatial-ai).


Started exploring comfy UI for some use cases I wanted to check on text to image models.

We had a fantastic meetup at Takshashila Institution, the place is welcoming with books. More details and video [here](https://github.com/letstalkspatial/2025-Nov) and [here](https://www.youtube.com/watch?v=WEQLLCmVOPI)
...
Gave a talk at BNMIT on Machine Learning for Climate science. You can find the slides [here](https://docs.google.com/presentation/d/19nyQz7SP90Pbh8Hc4moZbOOiALh746BYdWCQDDb5xfs/edit?usp=sharing). I built a [brush selection tool](https://plugins.qgis.org/plugins/BrushSelectionTool/) for qgis. I use it daily for my usecase. 


## August 2025

Had a workshop session for NITK on python data handling and mining. You can find the slides [here](https://docs.google.com/presentation/d/e/2PACX-1vTjbLuh63tgTX_BntnY9dwdtgTeZY3ZShuUN-AvQBnXGDtMy9OZ3CSo3VjBkTxs3eK_6LmD7EDIzpgx/pub?start=false&loop=false&delayms=3000). The associated github code is [here](https://github.com/amanbagrecha/nitk-workshop)
